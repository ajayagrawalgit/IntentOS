...
if _backend_dir.name == "backend" and _project_root.name == "src":
...
# 3. Serve Frontend Static Files (sibling to backend: src/frontend, or /app/frontend in Docker)
...
def read_root():
    ...
    return {"status": "ok", "message": "Backend running, frontend not found next to backend."}
